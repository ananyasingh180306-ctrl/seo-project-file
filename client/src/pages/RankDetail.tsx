  ...
  const fetchTracking = async () => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        console.error(res.data?.message || "Failed to load ranking tracking");
      }
    } catch (error) {
      console.error(error);
    } finally {
